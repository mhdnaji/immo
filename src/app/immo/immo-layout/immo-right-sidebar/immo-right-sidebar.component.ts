...
@Component({
  ...
  selector: 'app-immo-right-sidebar',
  templateUrl: './immo-right-sidebar.component.html',
  styleUrls: ['./immo-right-sidebar.component.sass'],
})
export class ImmoRightSidebarComponent implements OnInit, AfterViewInit {
