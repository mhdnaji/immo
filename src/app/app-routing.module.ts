...
const routes: Routes = [
    ...
    children: [
      {
        ...
        canActivate: [AuthGuard],
        loadChildren: () =>
        import('./immo/info-projet/info-projet.module').then((m) => m.InfoProjetModule),
      },
      {
        path: 'info-projet',
        loadChildren: () =>
      ...
      },
      {
        path: 'estimation',
        loadChildren: () =>
          import('./immo/estimation/estimation.module').then((m) => m.EstimationModule),
      },
      // {
      //   path: 'dashboard',
      //   canActivate: [AuthGuard],
  ...
  // },
  {
    ...
    component: AuthLayoutComponent,
    loadChildren: () =>
      import('./immo/authentication/authentication.module').then(
        (m) => m.AuthenticationModule
      ),
  },
